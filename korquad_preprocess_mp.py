...
def main():
    ...
    if not os.path.exists(korquad_processed_path):
        ...
        for idx in range(num_processes):
            ...
            p = mp.Process(target=raw_preprocess, args=(start_index, end_index, datasets, title_passage_map, train_list))
            processes.append(p)
            p.start()
